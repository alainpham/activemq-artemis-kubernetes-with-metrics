...
ARTEMIS_INSTANCE='/home/appuser/broker'
ARTEMIS_DATA_DIR='/home/appuser/broker/data'
ARTEMIS_ETC_DIR='/home/appuser/broker/etc'
ARTEMIS_OOME_DUMP='/home/appuser/broker/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/home/appuser/broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/home/appuser/broker/etc/'
...
# Java Opts
if [ -z "$JAVA_ARGS" ]; then
    JAVA_ARGS="-XX:AutoBoxCacheMax=20000 -XX:+PrintClassHistogram -XX:+UseG1GC -XX:+UseStringDeduplication  -Dhawtio.disableProxy=true -Dhawtio.realm=activemq -Dhawtio.offline=true -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml "
fi

# Adding additionnal java args like JAVA_APPEND_ARGS="-Xms64M -Xmx128M"
JAVA_ARGS="$JAVA_ARGS $JAVA_APPEND_ARGS"
